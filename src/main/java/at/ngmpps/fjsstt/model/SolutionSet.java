...
/**
 *
 * Proposed structure of a solution set. The examples in the javadoc refer to
 * the two solution sets given in
...
public class SolutionSet {
	...
	/**
	 * A Map of Strings representing the solution, one entry per job. The "Key"
	 * is the name of the job, the "Value" is the solution itself, e.g. "Job 0"
	 * -> (4,0,5) (13,9,4) (20,15,8) (22,29,3) (24,32,5) (19,48,6) "Job 1" ->
	 * (19,0,6) (27,13,6) (18,26,5) (13,31,4) (22,46,3) (1,53,3) ... (TODO: We
	 * can structure it even more as "Map<String, Solution>", where the type
	 * Solution would be a List<String> representing the steps of the solution.)
	 */
	...
	public SolutionSet(ProblemSet p, FJSSTTproblem fjp, Solution minUpperBound, Solution maxLowerBound) {
		this("Solution for Problem with id " + p.hashCode(), p.hashCode(), p.getFjs(), p.getTransport(), p.getProperties(),
				new HashMap<String, List<ScheduledOperation>>(), // do solution
																					// object below
		...
		if (s == null)
			s = maxLowerBound;
		if (s != null) {
			for (Integer j : s.getOperationsBeginTimes().keySet()) {
	...
	public SolutionSet(String name, int problemId, String problemFJS, String problemTransport, String problemConfig,
			Map<String, List<ScheduledOperation>> solution, Double minUpperBound, Double maxLowerBound) {
	...
	public String toString() {
		return "SolutionSet{" + "name='" + name + '\'' + ", problemId='" + problemId + '\'' + ", problemFJS='" + problemFJS + '\''
				+ ", problemTransport='" + problemTransport + '\'' + ", problemConfig='" + problemConfig + '\'' + ", solution=\'" + solution
				+ '\'' + ", minUpperBound=\'" + minUpperBoundSolution + '\'' + ", maxLowerBound=\'" + maxLowerBoundSolution + '\'' + '}';
	}
}
